...
--modified
INSERT INTO ata_contract VALUES (4,'0000051', '0000037', 'Divorce Party', 1200);
--added
INSERT INTO ata_contract VALUES (5,'0000053', '0000040', 'Other', 900);
...
*/
--modified
INSERT INTO ata_performance VALUES (1, TRUNC (SYSDATE - 10), TRUNC(SYSDATE - 10) + 15/24,
TRUNC(SYSDATE - 10) + 18/24);
INSERT INTO ata_performance VALUES (2, TRUNC (SYSDATE - 20), TRUNC(SYSDATE -20) + 15/24,
TRUNC(SYSDATE - 20) + 20/24);
INSERT INTO ata_performance VALUES (2, TRUNC (SYSDATE - 22), TRUNC(SYSDATE -22) + 15/24,
TRUNC(SYSDATE - 22) + 18/24);
INSERT INTO ata_performance VALUES (3, TRUNC (SYSDATE - 30), TRUNC(SYSDATE - 30) + 15/24,
TRUNC(SYSDATE - 30) + 21/24);
INSERT INTO ata_performance VALUES (3, TRUNC (SYSDATE - 23), TRUNC(SYSDATE - 23) + 10/24,
TRUNC(SYSDATE - 23) + 22/24);
INSERT INTO ata_performance VALUES (3,TRUNC (SYSDATE - 40), TRUNC(SYSDATE - 40) + 20/24,
TRUNC(SYSDATE - 40) + 23/24);
INSERT INTO ata_performance VALUES (4, TRUNC(SYSDATE - 50), TRUNC(SYSDATE - 50) + 14/24,
TRUNC(SYSDATE - 50) + 20/24);
INSERT INTO ata_performance VALUES (5, TRUNC(SYSDATE - 60), TRUNC(SYSDATE - 60) + 10/24,
TRUNC(SYSDATE - 60) + 18/24);

--if you would like to test for negative difference time
--INSERT INTO ata_performance VALUES (5, TRUNC(SYSDATE - 60), TRUNC(SYSDATE - 60) + 18/24,
--TRUNC(SYSDATE - 60) + 10/24);
